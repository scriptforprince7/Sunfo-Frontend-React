...
export default function Hot_list() {
  return (
    <div>
          ...
          <div className="block block-products slider">
            <div className="block-widget-wrap">
              <div className="block-title">
                <div className="sub-title">On Trend Hot Jewellery</div>
                <h2>The Hot List</h2>
              </div>
                ...
                <div className="section-column left">
                  <div className="intro-wrap">
                    ...
                    <div className="intro-item">
                      ...
                      pursuit of the best and most stunning jewellery that can
                      be offered at affordable price for you.
                    </div>
                    <div className="intro-item">
                      Visit our online catalogue and shop for the finest
                      earrings, rings, bracelets, watches, silver, and the most
                      luxurious gemstones.
                    </div>
